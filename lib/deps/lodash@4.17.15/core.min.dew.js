...
export function dew() {
  ...
  (function () {
    ...
    function i(n, t) {
      (this || _global).__wrapped__ = n, (this || _global).__actions__ = [], (this || _global).__chain__ = !!t;
    }
    ...
    function S(n, t, r) {
      function e() {
        for (var o = -1, i = arguments.length, c = -1, f = r.length, a = Array(f + i), l = (this || _global) && (this || _global) !== on && (this || _global) instanceof e ? u : n; ++c < f;) a[c] = r[c];
    ...
    function I(n, t, r) {
      return t = jn(t === Z ? n.length - 1 : t, 0), function () {
        ...
        return o[t] = r(i), n.apply(this || _global, o);
      };
    }
    ...
    function G(n, t) {
      ...
      return n = Fn(n), function () {
        return 0 < --n && (r = t.apply(this || _global, arguments)), 1 >= n && (t = Z), r;
      };
    }
    ...
    function Y(n, r, e) {
      var u = Dn(r),
          o = h(r, u);
      null != e || V(r) && (o.length || !u.length) || (e = r, r = n, n = this || _global, o = h(r, Dn(r)));
      var i = !(V(e) && "chain" in e && !e.chain),
          c = U(n);
      return mn(o, function (e) {
        var u = r[e];
        n[e] = u, c && (n.prototype[e] = function () {
          var r = (this || _global).__chain__;

          if (i || r) {
            var e = n((this || _global).__wrapped__);
            return (e.__actions__ = A((this || _global).__actions__)).push({
              func: u,
              args: arguments,
              thisArg: n
            }), e.__chain__ = r, e;
    ...
    var Z,
        ...
        on = typeof _global == "object" && _global && _global.Object === Object && _global || un || Function("return this")(),
        cn = (un = typeof exports == "object" && exports && !exports.nodeType && exports) && true && module && !module.nodeType && module,
        fn = function (n) {
      return function (t) {
        return null == n ? Z : n[t];
      };
    ...
    o.assignIn = Bn, o.before = G, o.bind = En, o.chain = function (n) {
      ...
      if (typeof n != "function") throw new TypeError("Expected a function");
      return function () {
        return !n.apply(this || _global, arguments);
      };
    }, o.once = function (n) {
      return G(2, n);
      ...
      return on._ === (this || _global) && (on._ = vn), this || _global;
      ...
      return w((this || _global).__wrapped__, (this || _global).__actions__);
